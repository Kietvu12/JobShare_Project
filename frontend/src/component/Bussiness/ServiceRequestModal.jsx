      ...
      >
        <div className="flex items-start gap-3 border-b border-slate-100 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-sm font-bold text-slate-900">{service.title}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 px-4 py-3">
          ...
          {isCredit ? (
            <label className="block">
              <span className="mb-1 block text-[10px] font-semibold text-slate-700">Số credit cần nạp</span>
              <input
                type="number"
                min="1"
                step="1"
                ...
                placeholder="VD: 2000"
                className="w-full rounded-lg border border-slate-200 px-3 py-2 text-xs outline-none focus:border-[#0077B6] focus:ring-1 focus:ring-[#0077B6]"
              />
            </label>
          ) : null}

          <label className="block">
            <span className="mb-1 block text-[10px] font-semibold text-slate-700">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-slate-200 px-3 py-2 text-xs outline-none focus:border-[#0077B6] focus:ring-1 focus:ring-[#0077B6]"
            />
          </label>

          {error ? (
            <p className="rounded-lg border border-rose-200 bg-rose-50 px-2.5 py-2 text-[10px] text-rose-700">
              {error}
            </p>
          ) : null}
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex flex-1 items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-bold text-white disabled:opacity-60"
