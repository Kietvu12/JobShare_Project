...
// Businesses (JobShare Business portal accounts)
export const Business = sequelize.define(
  'Business',
  {
    ...
    companySizeEn: {
      type: DataTypes.STRING(50),
      field: 'company_size_en'
    },
    companySizeJp: {
      type: DataTypes.STRING(50),
      field: 'company_size_jp'
    },
    website: {
      type: DataTypes.STRING(255)
    },
    ...
    contactNameEn: {
      type: DataTypes.STRING(255),
      field: 'contact_name_en'
    },
    contactNameJp: {
      type: DataTypes.STRING(255),
      field: 'contact_name_jp'
    },
    contactTitle: {
      type: DataTypes.STRING(255),
      allowNull: false,
    ...
    contactTitleEn: {
      type: DataTypes.STRING(255),
      field: 'contact_title_en'
    },
    contactTitleJp: {
      type: DataTypes.STRING(255),
      field: 'contact_title_jp'
    },
    contactEmail: {
      type: DataTypes.STRING(255),
      allowNull: false,
    ...
    rejectionReasonEn: {
      type: DataTypes.TEXT,
      field: 'rejection_reason_en'
    },
    rejectionReasonJp: {
      type: DataTypes.TEXT,
      field: 'rejection_reason_jp'
    },
    lastLoginAt: {
      type: DataTypes.DATE,
      field: 'last_login_at'
...
export const BusinessJobCategory = sequelize.define(
  'BusinessJobCategory',
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
  ...
  {
    tableName: 'business_job_categories',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at'
  }
...
export const BusinessCreditHistory = sequelize.define(
  ...
  {
    tableName: 'business_credit_histories',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at'
  }
...
export const ScoutSetting = sequelize.define(
  'ScoutSetting',
  {
    id: {
...
export const ScoutListingLog = sequelize.define(
  'ScoutListingLog',
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
    ...
    actorAdminId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
      field: 'actor_admin_id'
    },
    actorCollaboratorId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
      field: 'actor_collaborator_id'
    },
    note: {
      type: DataTypes.TEXT,
      allowNull: true
...
export const BusinessScoutUnlock = sequelize.define(
  'BusinessScoutUnlock',
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
  ...
  {
    tableName: 'business_scout_unlocks',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at'
  }
...
export const BusinessSavedCandidate = sequelize.define(
  ...
  {
    tableName: 'business_saved_candidates',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at'
  }
...
export const BusinessScoutPerformanceRequest = sequelize.define(
  'BusinessScoutPerformanceRequest',
  {
    ...
    handledByCollaboratorId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
      field: 'handled_by_collaborator_id',
    },
    scoutUnlockId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
...
export const BusinessLandingPage = sequelize.define(
  'BusinessLandingPage',
  {
    ...
    businessId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'business_id' },
    jobId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, field: 'job_id' },
    title: { type: DataTypes.STRING(255), allowNull: false },
    slug: { type: DataTypes.STRING(220), allowNull: false, unique: true },
    templateKey: { type: DataTypes.STRING(80), allowNull: false, defaultValue: 'classic', field: 'template_key' },
    ...
    metaKeywords: { type: DataTypes.STRING(500), allowNull: true, field: 'meta_keywords' },
    metaImage: { type: DataTypes.STRING(500), allowNull: true, field: 'meta_image' },
    ogTitle: { type: DataTypes.STRING(255), allowNull: true, field: 'og_title' },
    ogDescription: { type: DataTypes.STRING(500), allowNull: true, field: 'og_description' },
    ...
    viewsCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'views_count' },
    formSubmissionsCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'form_submissions_count' },
    candidatesCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'candidates_count' },
  },
  {
    tableName: 'business_landing_pages',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at',
    paranoid: true,
...
export const BusinessLandingPageSubmission = sequelize.define(
  'BusinessLandingPageSubmission',
  {
    id: { type: DataTypes.BIGINT.UNSIGNED, primaryKey: true, autoIncrement: true },
    landingPageId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'landing_page_id' },
    businessId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'business_id' },
    jobId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, field: 'job_id' },
    applicantName: { type: DataTypes.STRING(255), allowNull: false, field: 'applicant_name' },
    applicantEmail: { type: DataTypes.STRING(255), allowNull: false, field: 'applicant_email' },
    applicantPhone: { type: DataTypes.STRING(50), allowNull: true, field: 'applicant_phone' },
    message: { type: DataTypes.TEXT, allowNull: true },
    payloadJson: { type: DataTypes.JSON, allowNull: true, field: 'payload_json' },
  },
  {
    tableName: 'business_landing_page_submissions',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at',
  }
...
export const BusinessLandingPageActivity = sequelize.define(
  'BusinessLandingPageActivity',
  {
    id: { type: DataTypes.BIGINT.UNSIGNED, primaryKey: true, autoIncrement: true },
    landingPageId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'landing_page_id' },
    businessId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'business_id' },
    activityType: { type: DataTypes.STRING(50), allowNull: false, field: 'activity_type' },
    message: { type: DataTypes.STRING(500), allowNull: false },
    metadataJson: { type: DataTypes.JSON, allowNull: true, field: 'metadata_json' },
  },
  {
    tableName: 'business_landing_page_activities',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: false,
  }
...
export const BusinessCtvMarketplaceListing = sequelize.define(
  'BusinessCtvMarketplaceListing',
  {
    id: { type: DataTypes.BIGINT.UNSIGNED, primaryKey: true, autoIncrement: true },
    businessId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'business_id' },
    jobId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'job_id' },
    referralFeeType: { type: DataTypes.STRING(20), allowNull: false, defaultValue: 'percent', field: 'referral_fee_type' },
    referralFeeValue: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0, field: 'referral_fee_value' },
    maxBonusAmount: { type: DataTypes.DECIMAL(15, 2), allowNull: true, field: 'max_bonus_amount' },
    headcount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 1 },
    requirements: { type: DataTypes.TEXT, allowNull: true },
    recruitmentDeadline: { type: DataTypes.DATEONLY, allowNull: true, field: 'recruitment_deadline' },
    platformFeePercent: { type: DataTypes.DECIMAL(5, 2), allowNull: false, defaultValue: 20, field: 'platform_fee_percent' },
    status: { type: DataTypes.TINYINT, allowNull: false, defaultValue: 0 },
    ...
    handledByAdminId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, field: 'handled_by_admin_id' },
    rejectionReason: { type: DataTypes.TEXT, allowNull: true, field: 'rejection_reason' },
    adminNote: { type: DataTypes.TEXT, allowNull: true, field: 'admin_note' },
    jobPickupId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, field: 'job_pickup_id' },
    interestCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'interest_count' },
    nominationsCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'nominations_count' },
    hiredCount: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0, field: 'hired_count' },
  },
  {
    tableName: 'business_ctv_marketplace_listings',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at',
    paranoid: true,
...
export const BusinessCtvMarketplaceInterest = sequelize.define(
  'BusinessCtvMarketplaceInterest',
  {
    id: { type: DataTypes.BIGINT.UNSIGNED, primaryKey: true, autoIncrement: true },
    listingId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'listing_id' },
    collaboratorId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'collaborator_id' },
  },
  {
    tableName: 'business_ctv_marketplace_interests',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: false,
  }
...
export const BusinessCtvMarketplaceSettlement = sequelize.define(
  'BusinessCtvMarketplaceSettlement',
  {
    id: { type: DataTypes.BIGINT.UNSIGNED, primaryKey: true, autoIncrement: true },
    listingId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'listing_id' },
    jobApplicationId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'job_application_id' },
    businessId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, field: 'business_id' },
    collaboratorId: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, field: 'collaborator_id' },
    candidateName: { type: DataTypes.STRING(255), allowNull: true, field: 'candidate_name' },
    totalAmountBusiness: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0, field: 'total_amount_business' },
    platformFeePercent: { type: DataTypes.DECIMAL(5, 2), allowNull: false, defaultValue: 20, field: 'platform_fee_percent' },
    platformFeeAmount: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0, field: 'platform_fee_amount' },
    ctvPayoutAmount: { type: DataTypes.DECIMAL(15, 2), allowNull: false, defaultValue: 0, field: 'ctv_payout_amount' },
    status: { type: DataTypes.STRING(30), allowNull: false, defaultValue: 'pending' },
    paidAt: { type: DataTypes.DATE, allowNull: true, field: 'paid_at' },
  },
  {
    tableName: 'business_ctv_marketplace_settlements',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at',
  }
...
export const CVStorage = sequelize.define(
  'CVStorage',
  {
    ...
    jpConversationLevel: {
      type: DataTypes.TINYINT,
      field: 'jp_conversation_level'
    },
    enConversationLevel: {
      type: DataTypes.TINYINT,
      field: 'en_conversation_level'
    },
    otherConversationLevel: {
      type: DataTypes.TINYINT,
      field: 'other_conversation_level'
    },
    experienceYears: {
      type: DataTypes.TINYINT,
    ...
    languageSkillRemarks: {
      type: DataTypes.TEXT,
      field: 'language_skill_remarks'
    },
    curriculumVitae: {
      type: DataTypes.STRING(255),
    ...
    scoutPublicSummary: {
      type: DataTypes.TEXT,
      allowNull: true,
      field: 'scout_public_summary'
    },
    scoutListedAt: {
      type: DataTypes.DATE,
      allowNull: true,
      field: 'scout_listed_at'
    },
    scoutUnlistedAt: {
      type: DataTypes.DATE,
      allowNull: true,
      field: 'scout_unlisted_at'
    },
    scoutListedByAdminId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
      field: 'scout_listed_by_admin_id'
    },
    scoutListedByCollaboratorId: {
      type: DataTypes.BIGINT.UNSIGNED,
      allowNull: true,
...
export const MessageRead = sequelize.define(
  'MessageRead',
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
    ...
    readerType: {
      type: DataTypes.ENUM('admin', 'collaborator', 'applicant'),
      allowNull: false,
      field: 'reader_type'
    },
    adminId: {
...
Business.belongsToMany(JobCategory, {
  through: BusinessJobCategory,
  as: 'jobCategories',
  foreignKey: 'businessId',
  otherKey: 'jobCategoryId'
});
JobCategory.belongsToMany(Business, {
  through: BusinessJobCategory,
  as: 'businesses',
  foreignKey: 'jobCategoryId',
  otherKey: 'businessId'
});
BusinessJobCategory.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessJobCategory.belongsTo(JobCategory, { as: 'jobCategory', foreignKey: 'jobCategoryId' });
Business.hasMany(BusinessJobCategory, { as: 'businessJobCategories', foreignKey: 'businessId' });
Business.hasMany(BusinessCreditHistory, { as: 'creditHistories', foreignKey: 'businessId' });
BusinessCreditHistory.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessCreditHistory.belongsTo(Admin, { as: 'admin', foreignKey: 'adminId' });
Business.hasMany(BusinessScoutUnlock, { as: 'scoutUnlocks', foreignKey: 'businessId' });
Business.hasMany(BusinessSavedCandidate, { as: 'savedCandidates', foreignKey: 'businessId' });
BusinessScoutUnlock.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessScoutUnlock.belongsTo(CVStorage, { as: 'cv', foreignKey: 'cvId' });
BusinessScoutUnlock.belongsTo(BusinessCreditHistory, { as: 'creditHistory', foreignKey: 'creditHistoryId' });
BusinessSavedCandidate.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessSavedCandidate.belongsTo(CVStorage, { as: 'cv', foreignKey: 'cvId' });
BusinessSavedCandidate.belongsTo(BusinessScoutUnlock, { as: 'scoutUnlock', foreignKey: 'scoutUnlockId' });
CVStorage.hasMany(BusinessScoutUnlock, { as: 'scoutUnlocks', foreignKey: 'cvId' });
CVStorage.hasMany(BusinessSavedCandidate, { as: 'businessSavedCandidates', foreignKey: 'cvId' });
BusinessScoutPerformanceRequest.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessScoutPerformanceRequest.belongsTo(CVStorage, { as: 'cv', foreignKey: 'cvId' });
...
Job.hasMany(BusinessLandingPage, { as: 'landingPages', foreignKey: 'jobId' });
BusinessLandingPageSubmission.belongsTo(BusinessLandingPage, { as: 'landingPage', foreignKey: 'landingPageId' });
BusinessLandingPageSubmission.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessLandingPage.hasMany(BusinessLandingPageSubmission, { as: 'submissions', foreignKey: 'landingPageId' });
BusinessLandingPageActivity.belongsTo(BusinessLandingPage, { as: 'landingPage', foreignKey: 'landingPageId' });
BusinessLandingPage.hasMany(BusinessLandingPageActivity, { as: 'activities', foreignKey: 'landingPageId' });
BusinessCtvMarketplaceListing.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessCtvMarketplaceListing.belongsTo(Job, { as: 'job', foreignKey: 'jobId' });
BusinessCtvMarketplaceListing.belongsTo(Admin, { as: 'handledByAdmin', foreignKey: 'handledByAdminId' });
BusinessCtvMarketplaceListing.belongsTo(JobPickup, { as: 'jobPickup', foreignKey: 'jobPickupId' });
Business.hasMany(BusinessCtvMarketplaceListing, { as: 'ctvMarketplaceListings', foreignKey: 'businessId' });
Job.hasMany(BusinessCtvMarketplaceListing, { as: 'ctvMarketplaceListings', foreignKey: 'jobId' });
BusinessCtvMarketplaceInterest.belongsTo(BusinessCtvMarketplaceListing, { as: 'listing', foreignKey: 'listingId' });
BusinessCtvMarketplaceInterest.belongsTo(Collaborator, { as: 'collaborator', foreignKey: 'collaboratorId' });
BusinessCtvMarketplaceListing.hasMany(BusinessCtvMarketplaceInterest, { as: 'interests', foreignKey: 'listingId' });
BusinessCtvMarketplaceSettlement.belongsTo(BusinessCtvMarketplaceListing, { as: 'listing', foreignKey: 'listingId' });
BusinessCtvMarketplaceSettlement.belongsTo(JobApplication, { as: 'jobApplication', foreignKey: 'jobApplicationId' });
BusinessCtvMarketplaceSettlement.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
BusinessCtvMarketplaceSettlement.belongsTo(Collaborator, { as: 'collaborator', foreignKey: 'collaboratorId' });
BusinessCtvMarketplaceListing.hasMany(BusinessCtvMarketplaceSettlement, { as: 'settlements', foreignKey: 'listingId' });
CVStorage.hasMany(ScoutListingLog, { as: 'scoutListingLogs', foreignKey: 'cvId' });
ScoutListingLog.belongsTo(CVStorage, { as: 'cv', foreignKey: 'cvId' });
ScoutListingLog.belongsTo(Admin, { as: 'actorAdmin', foreignKey: 'actorAdminId' });
ScoutListingLog.belongsTo(Collaborator, { as: 'actorCollaborator', foreignKey: 'actorCollaboratorId' });
CVStorage.belongsTo(Admin, { as: 'scoutListedByAdmin', foreignKey: 'scoutListedByAdminId' });
CVStorage.belongsTo(Collaborator, { as: 'scoutListedByCollaborator', foreignKey: 'scoutListedByCollaboratorId' });
...
Message.belongsTo(Business, { as: 'business', foreignKey: 'businessId' });
...
MessageRead.belongsTo(Admin, { as: 'admin', foreignKey: 'adminId' });
Admin.hasMany(MessageRead, { as: 'messageReads', foreignKey: 'adminId' });

MessageRead.belongsTo(Collaborator, { as: 'collaborator', foreignKey: 'collaboratorId' });
Collaborator.hasMany(MessageRead, { as: 'messageReads', foreignKey: 'collaboratorId' });

MessageRead.belongsTo(Applicant, { as: 'applicant', foreignKey: 'applicantId' });
Applicant.hasMany(MessageRead, { as: 'messageReads', foreignKey: 'applicantId' });
