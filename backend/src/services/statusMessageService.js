...
export const statusMessageService = {
   ...
   */
  createStatusMessage: async ({ jobApplicationId, oldStatus, newStatus, adminId = null, businessId = null, note = null, paymentAmount = null }) => {
    try {
      ...
      const actorLabel = businessId ? 'Doanh nghiệp' : 'Admin';
      let content = `📋 **Cập nhật trạng thái đơn ứng tuyển** (${actorLabel})\n\n`;
      ...
      const message = await Message.create({
        ...
        content,
        isReadByAdmin: !businessId,
        isReadByBusiness: !!businessId,
