...
import { typeController } from '../admin/typeController.js';
import { valueController } from '../admin/valueController.js';
...
export const businessCandidateSharingController = {
  ...
  getCommissionTypes: typeController.getAllTypes,

  getCommissionValuesByType: valueController.getValuesByType,
};
