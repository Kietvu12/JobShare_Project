...
import adminWsChatRoutes from './routes/adminWsChatRoutes.js';
...
import businessWsChatRoutes from './routes/businessWsChatRoutes.js';
...
app.use('/api/admin/ws-chat', adminWsChatRoutes);
...
app.use('/api/business/ws-chat', businessWsChatRoutes);
...
app.use('/api/business/knowledge', businessKnowledgeRoutes);
