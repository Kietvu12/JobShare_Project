...
router.get('/job-applications/unread-messages', authenticate, isSuperAdminOrBackoffice, jobApplicationController.getUnreadMessagesByJobApplication);
router.get('/job-applications/unread-messages', authenticate, isSuperAdminOrBackoffice, (await import('../controllers/admin/jobApplicationController.js')).jobApplicationController.getUnreadMessagesByJobApplication);
