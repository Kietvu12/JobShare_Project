...
import { scoutListingController } from '../controllers/collaborator/scoutListingController.js';
...
/**
 * @route   POST /api/ctv/cvs/:id/scout/list
 * @desc    CTV đưa hồ sơ lên sàn Scout
 */
router.post('/:id/scout/list', authenticateCTV, scoutListingController.listCv);

/**
 * @route   POST /api/ctv/cvs/:id/scout/unlist
 * @desc    CTV gỡ hồ sơ khỏi sàn Scout
 */
router.post('/:id/scout/unlist', authenticateCTV, scoutListingController.unlistCv);
