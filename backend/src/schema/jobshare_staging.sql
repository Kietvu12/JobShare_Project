...
--
-- Host: localhost    Database: jobshare_staging
-- ------------------------------------------------------
...
CREATE TABLE `action_logs` (
  ...
  `object` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'T├¬n object/model ─æã░ß╗úc thao t├íc (Job, JobApplication, CVStorage, etc.)',
  `action` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'H├ánh ─æß╗Öng: login, logout, create, edit, delete, import',
  `ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IP address cß╗ºa admin',
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'M├┤ tß║ú chi tiß║┐t action',
...
) ENGINE=InnoDB AUTO_INCREMENT=35537 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `benefits` (
  ...
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=10314 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `business_credit_requests`
--

DROP TABLE IF EXISTS `business_credit_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `business_credit_requests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `business_id` bigint unsigned NOT NULL COMMENT 'Doanh nghiệp → businesses.id',
  `request_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mã yêu cầu, vd CR-2607-001',
  `amount` int NOT NULL COMMENT 'Số credit yêu cầu nạp',
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Ghi chú / lý do',
  `payment_method` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'bank_transfer | other',
...
CREATE TABLE `business_invoices` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `business_id` bigint unsigned NOT NULL COMMENT 'Doanh nghiệp → businesses.id',
  `invoice_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mã hóa đơn, vd INV-2405-028',
  ...
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid' COMMENT 'draft | unpaid | paid | cancelled',
...
--
-- Table structure for table `business_job_builder_threads`
--

DROP TABLE IF EXISTS `business_job_builder_threads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `business_job_builder_threads` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `business_id` bigint unsigned NOT NULL,
  ...
  KEY `job_id` (`job_id`),
  CONSTRAINT `business_job_builder_threads_ibfk_59` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_job_builder_threads_ibfk_60` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
--
-- Table structure for table `business_scout_performance_recommendations`
--

DROP TABLE IF EXISTS `business_scout_performance_recommendations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `business_scout_performance_recommendations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `request_id` bigint unsigned NOT NULL,
  `cv_id` bigint unsigned NOT NULL,
  `source` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system' COMMENT 'scout | ctv | system',
  `admin_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `business_scout_performance_requests` (
  ...
  `requested_at` timestamp NULL DEFAULT NULL,
  `handled_at` timestamp NULL DEFAULT NULL,
  `business_viewed_at` timestamp NULL DEFAULT NULL COMMENT 'DN mở thông báo/kết quả lần đầu',
  `business_explore_status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'interested | declined',
  `wants_similar_candidates` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'DN yêu cầu WS tìm thêm ứng viên tương tự',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `business_ws_chat_messages`
--

DROP TABLE IF EXISTS `business_ws_chat_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `business_ws_chat_messages` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `business_ws_chat_sessions`
--

DROP TABLE IF EXISTS `business_ws_chat_sessions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `business_ws_chat_sessions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `business_id` bigint unsigned NOT NULL,
...
CREATE TABLE `calendars` (
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Ti├¬u ─æß╗ü lß╗ïch hß║╣n',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Ghi ch├║ chi tiß║┐t cho lß╗ïch hß║╣n',
  ...
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `campaign_applications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `cover_letter_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_letter_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `campaigns` (
  ...
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Đường dẫn ảnh cover — S3 key hoặc URL/path',
  PRIMARY KEY (`id`)
...
CREATE TABLE `categories` (
  ...
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `color_en` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `color_jp` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `collaborator_assignments` (
  ...
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Ghi chú về phân công',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1: active, 0: inactive',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `collaborator_notifications` (
  ...
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `url_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `url_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4477 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `collaborator_saved_lists` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên playlist (VD: Việc làm IT yêu thích)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `collaborator_saved_search_criteria` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên gợi nhớ (VD: Tìm kiếm IT Tokyo)',
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `filters_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `filters_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `collaborators` (
  ...
  `organization_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
  ...
  `organization_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verification_token_hash_jp` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `organization_type_jp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_address_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_license_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `avatar_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zalo_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_account_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_account_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_branch_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `organization_link_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verification_token_hash_en` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `organization_type_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_address_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_license_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `avatar_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zalo_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_account_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_account_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_branch_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `organization_link_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `companies` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `company_business_fields` (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nß╗Öi dung l─®nh vß╗▒c kinh doanh',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `content_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `company_offices` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_company` bigint unsigned NOT NULL COMMENT 'ID cß╗ºa company',
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '─Éß╗ïa chß╗ë v─ân ph├▓ng',
...
CREATE TABLE `cv_storages` (
  ...
  `ages` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_origin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `other_country` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_current` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `postal_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'M├ú bã░u ─æiß╗çn',
  `spouse` tinyint DEFAULT NULL,
  `current_income` int DEFAULT NULL,
  `desired_income` int DEFAULT NULL,
  `desired_work_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desired_position` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Vß╗ï tr├¡ mong muß╗æn',
  `nyusha_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `technical_skills` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Kß╗╣ n─âng kß╗╣ thuß║¡t',
  `certificates` json DEFAULT NULL,
  `career_summary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'T├│m tß║»t nghß╗ü nghiß╗çp',
  `strengths` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '─Éiß╗âm mß║ính',
  `motivation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '─Éß╗Öng lß╗▒c ß╗®ng tuyß╗ân',
  `other_documents` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_skill_remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `photo_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `curriculum_vitae` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_original_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'S3/local path: CV gốc (file upload)',
  `cv_career_history_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'S3/local path: CV 職務経歴書 (tab 2)',
  `avatar_photo_path` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Đường dẫn ảnh hồ sơ (profile photo) trong snapshot — S3 key hoặc path tương đối',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` tinyint NOT NULL DEFAULT '1',
  ...
  `completion_state` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ready_for_parse',
  `vector_sync_status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `vector_sync_requested_at` datetime DEFAULT NULL,
  `vector_sync_completed_at` datetime DEFAULT NULL,
  `vector_sync_last_error` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `furigana_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ages_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_origin_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_country_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_current_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desired_work_location_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desired_position_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nyusha_time_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interview_time_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `learned_tools_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `experience_tools_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `educations_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `work_experiences_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `technical_skills_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `certificates_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `career_summary_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `strengths_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `motivation_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_documents_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `curriculum_vitae_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cv_table_layout_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `admin_supplement_marks_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `furigana_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ages_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_origin_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_country_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_current_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desired_work_location_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desired_position_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nyusha_time_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interview_time_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `learned_tools_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `experience_tools_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `educations_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `work_experiences_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `technical_skills_en` json DEFAULT NULL,
  `certificates_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `career_summary_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `strengths_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `motivation_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_documents_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `curriculum_vitae_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cv_table_layout_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `admin_supplement_marks_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `email_newsletters` (
  ...
  `file_attachment_original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `subject_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipients_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file_attachment_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_attachment_original_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subject_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipients_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file_attachment_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_attachment_original_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `email_to_collaborator` (
  ...
  `recipient_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'specific',
  `attachments` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `sent_at` timestamp NULL DEFAULT NULL,
  `recipients_count` int NOT NULL DEFAULT '0',
  `file_attachment_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_attachment_original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  ...
  `subject_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recipients_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipients_detail_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipient_type_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachments_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_attachment_original_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `subject_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recipients_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipients_detail_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipient_type_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachments_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_attachment_original_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `event_participants` (
  ...
  `admin_id` bigint unsigned DEFAULT NULL,
  `collaborator_id` bigint unsigned DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email khi tham gia bên ngoài (external)',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tên khi tham gia bên ngoài (external)',
...
CREATE TABLE `events` (
  ...
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `location_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `location_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `faqs` (
  ...
  `question_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `answer_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `home_setting_company_infos` (
  ...
  `establishment_date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `main_business` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `company_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `company_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `establishment_date_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_address_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `representative_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_business_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `company_email_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `establishment_date_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_address_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `representative_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `main_business_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `company_email_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `home_setting_jobs` (
  ...
  `salary_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '1: active, 0: inactive',
  `popup` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_en` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `requirement_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `salary_unit_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `popup_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_jp` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `requirement_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `salary_unit_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `popup_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `job_application_memos` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` datetime DEFAULT NULL,
  `note_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `note_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `job_applications` (
  ...
  `title` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Ti├¬u ─æß╗ü',
  ...
  `cv_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'M├ú CV (code) tham chiß║┐u cv_storages.code',
  `cv_path` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `reject_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'L├¢ do tß╗½ chß╗æi',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `title_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reject_note_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `title_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reject_note_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `assignment_note_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `memo_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `assignment_note_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `memo_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `job_recruiting_companies` (
  ...
  `company_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tên công ty',
  `revenue` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Doanh thu',
  `number_of_employees` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Số nhân viên',
  `headquarters` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Trụ sở tại',
  `company_introduction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Giới thiệu chung về công ty',
  `stock_exchange_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Thông tin trên sàn chứng khoán',
  `investment_capital` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Vốn đầu tư',
  `established_date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Thành lập',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `company_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `revenue_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_of_employees_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `headquarters_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_introduction_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `stock_exchange_info_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `investment_capital_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `established_date_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `revenue_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_of_employees_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `headquarters_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_introduction_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `stock_exchange_info_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `investment_capital_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `established_date_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=666 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Thông tin công ty tuyển dụng thực tế trong JD';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_recruiting_company_business_sectors` (
  ...
  `sector_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên lĩnh vực kinh doanh',
  `order` int NOT NULL DEFAULT '0' COMMENT 'Thứ tự hiển thị',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `sector_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sector_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2024 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Các lĩnh vực kinh doanh của công ty tuyển dụng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_recruiting_company_services` (
  ...
  `service_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=935 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Các dịch vụ cung cấp của công ty tuyển dụng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_values` (
  ...
  `value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Gi├í trß╗ï cß╗Ñ thß╗â (v├¡ dß╗Ñ: sß╗æ tiß╗ün, phß║ºn tr─âm)',
  `is_required` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0: Kh├┤ng bß║»t buß╗Öc, 1: Bß║»t buß╗Öc',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `value_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `view_on_collaborator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Giá trị hiển thị cho CTV',
  `view_on_collaborator_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `view_on_collaborator_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=5451 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jobs` (
  ...
  `business_sector_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `number_of_hires` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Số lượng tuyển dụng (VI)',
  `number_of_hires_en` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_of_hires_jp` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bonus` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `salary_review` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `holidays` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `social_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `transportation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `break_time` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `overtime` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `contract_period` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `company_id` bigint unsigned DEFAULT NULL,
  `business_id` bigint unsigned DEFAULT NULL COMMENT 'Doanh nghiệp tạo job → businesses.id',
  `recruitment_process` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `views_count` int NOT NULL DEFAULT '0',
  `deadline` date DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '0: Draft, 1: Published, 2: Closed, 3: Expired',
  `is_pinned` tinyint(1) NOT NULL DEFAULT '0',
  `jd_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jd_original_filename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_hot` tinyint(1) DEFAULT '0' COMMENT '0: Kh├┤ng, 1: C├│',
  `job_commission_type` enum('fixed','percent') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'fixed' COMMENT 'Loß║íi hoa hß╗ông: fixed = cß╗æ ─æß╗ïnh, percent = phß║ºn tr─âm',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `required_cv_form` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '─Éã░ß╗Øng dß║½n file form CV bß║»t buß╗Öc cß╗ºa kh├ích h├áng',
  `required_cv_form_original_filename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'T├¬n file gß╗æc cß╗ºa form CV bß║»t buß╗Öc',
  `title_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `instruction_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bonus_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `salary_review_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `holidays_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `social_insurance_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `transportation_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `break_time_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `overtime_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contract_period_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recruitment_process_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `instruction_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recruitment_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Lý do tuyển dụng (VI)',
  `recruitment_reason_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recruitment_reason_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bonus_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `salary_review_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `salary_currency` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'JPY' COMMENT 'Đơn vị tiền lương: JPY, VND, USD',
  `holidays_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `holiday_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Chi tiết ngày nghỉ (VI)',
  `holiday_details_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `holiday_details_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `social_insurance_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `transportation_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `break_time_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `overtime_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contract_period_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recruitment_process_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `highlights` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `residence_status` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `residence_status_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `residence_status_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_period` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_period_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_period_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_detail_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `probation_detail_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `jd_original_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jd_file_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jd_file_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transfer_ability` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transfer_ability_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transfer_ability_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_advise_vi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Admin advise (vi)',
  `admin_advise_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Admin advise (en)',
  `admin_advise_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Admin advise (jp)',
  `business_sector_key_jp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `highlights_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `admin_advise_vi_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_sector_key_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `highlights_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `admin_advise_vi_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `mail_settings` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `note_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nß╗Öi dung tin nhß║»n',
  `attachment_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachment_key` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachment_mime_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `outlook_connections` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `access_token_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `refresh_token_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `access_token_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `refresh_token_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `overtime_allowances` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `job_id` bigint unsigned NOT NULL,
  `overtime_allowance_range` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `overtime_allowance_range_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `overtime_allowance_range_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payment_requests` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `note_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `rejected_reason_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `note_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `rejected_reason_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `posts` (
  ...
  `tag_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `meta_keywords_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_image_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `image_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tag_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_title_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_description_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_keywords_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_image_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `public_candidate_chat_messages` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `session_id` bigint unsigned NOT NULL,
  `sender_type` enum('visitor','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_id` bigint unsigned DEFAULT NULL,
  `body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `body_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `public_candidate_chat_sessions` (
  ...
  `visitor_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applicant_id` bigint unsigned DEFAULT NULL,
  ...
  `session_token_jp` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visitor_label_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_jp` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `session_token_en` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visitor_label_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_en` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `requirements` (
  ...
  `job_id` bigint unsigned NOT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'education: Hß╗ìc vß║Ñn, technique: Kß╗╣ thuß║¡t',
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'required: Bß║»t buß╗Öc, optional: T├╣y chß╗ìn, first_stand: ã»u ti├¬n',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `content_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_jp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_jp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=10750 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `salary_ranges` (
  ...
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'month: Theo th├íng, year: Theo n─âm',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `salary_range_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `salary_range_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_jp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `search_history` (
  ...
  `keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Từ khóa tìm kiếm',
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `keyword_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filters_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `keyword_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filters_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4073 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch sử tìm kiếm của CTV';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `synced_emails` (
  ...
  `internet_message_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `folder` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inbox',
  `direction` enum('inbound','outbound') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inbound',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `subject_en` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `body_preview_en` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `from_email_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `from_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `to_recipients_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cc_recipients_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bcc_recipients_en` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `importance_en` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `folder_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subject_jp` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `body_preview_jp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `from_email_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `from_name_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `to_recipients_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cc_recipients_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bcc_recipients_jp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `importance_jp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `folder_jp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `types` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `typename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'T├¬n loß║íi setting (v├¡ dß╗Ñ: JLPT, Experience, Specialization, Qualification)',
  `cv_field` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tên field trong CV để so sánh (ví dụ: jlptLevel, experienceYears, specialization, qualification)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `typename_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_field_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `typename_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cv_field_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `values` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_typename` bigint unsigned NOT NULL COMMENT 'ID cß╗ºa type',
  `valuename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'T├¬n gi├í trß╗ï (v├¡ dß╗Ñ: N1, N2, N3 cho JLPT; 1Õ╣┤, 2Õ╣┤ cho Experience)',
  `comparison_operator` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Toán tử so sánh: >=, <=, >, <, =, between',
  `comparison_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Giá trị để so sánh (ví dụ: 3 cho N3, 3 cho 3 năm)',
  `comparison_value_end` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Giá trị kết thúc cho between (ví dụ: 5 cho "từ 2 đến 5")',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `valuename_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_operator_en` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_value_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_value_end_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valuename_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_operator_jp` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_value_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comparison_value_end_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `working_hours` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `working_hours_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `working_hours_jp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4140 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-08-24 23:38:59
